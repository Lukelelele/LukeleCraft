...
public class LCStructures {
     ...
     */
    public static final DeferredRegister<Structure<?>> DEFERRED_REGISTRY_STRUCTURE = DeferredRegister.create(ForgeRegistries.STRUCTURE_FEATURES, LukeleCraftMain.MOD_ID);
    ...
    public static final RegistryObject<Structure<NoFeatureConfig>> DUNGEON = setupStructure("dungeon", () -> (new TesterStructure(NoFeatureConfig.field_236558_a_)));
    /**
