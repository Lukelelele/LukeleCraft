package com.lukele.lukelecraft.items.armor;
...
public enum ModArmorMaterial implements IArmorMaterial {
    ...
    RUBY(LukeleCraftMain.MOD_ID + ":ruby", 25, new int[]{ 2, 5, 6, 2 }, 18, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 2.0f, () -> {return Ingredient.fromItems(ModItems.RUBY.get()); });
